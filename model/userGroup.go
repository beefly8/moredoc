...
type UserGroup struct {
	...
	UserId    int64      `form:"user_id" json:"user_id,omitempty" gorm:"column:user_id;type:bigint;size:20;default:0;index:user_group,unique;index:user_id;comment:用户ID;"`
	GroupId   int64      `form:"group_id" json:"group_id,omitempty" gorm:"column:group_id;type:bigint;size:20;default:0;index:user_group,unique;comment:组ID;"`

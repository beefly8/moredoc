...
type Banner struct {
	...
	Enable      bool       `form:"enable" json:"enable,omitempty" gorm:"column:enable;type:boolean;size:4;default:1;"`
	Type        int8       `form:"type" json:"type,omitempty" gorm:"column:type;type:integer;size:4;default:0;comment:0 网站轮播图，1 小程序轮播图，2 APP轮播图;"`

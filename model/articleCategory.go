...
type ArticleCategory struct {
	...
	ArticleId  int64      `form:"article_id" json:"article_id,omitempty" gorm:"column:article_id;type:integer;size:11;default:0;index:idx_article_id;index:idx_article_category,unique;comment:文章ID;"`
	CategoryId int64      `form:"category_id" json:"category_id,omitempty" gorm:"column:category_id;type:integer;size:11;default:0;index:idx_category_id;index:idx_article_category,unique;comment:分类ID;"`

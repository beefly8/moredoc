...
type Sign struct {
	...
	UserId    int64      `form:"user_id" json:"user_id,omitempty" gorm:"column:user_id;type:bigint;size:20;default:0;index:idx_user_id;index:idx_user_sign_at,unique;comment:签到的用户ID;"`
	Ip        string     `form:"ip" json:"ip,omitempty" gorm:"column:ip;type:varchar(64);size:64;comment:签到的用户IP;"`
	SignAt    int        `form:"sign_at" json:"sign_at,omitempty" gorm:"column:sign_at;type:integer;size:11;default:0;index:idx_user_sign_at,unique;comment:签到时间，格式20060102;"`
	...
	Award     int32      `form:"award" json:"award,omitempty" gorm:"column:award;type:integer;size:11;default:0;comment:奖励积分;"`
}

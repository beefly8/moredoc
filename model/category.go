...
type Category struct {
	...
	ParentId        int64      `form:"parent_id" json:"parent_id,omitempty" gorm:"column:parent_id;type:integer;size:11;default:0;index:idx_unique_title,unique;index:parent_id;comment:上级ID;"`
	...
	DocCount        int        `form:"doc_count" json:"doc_count,omitempty" gorm:"column:doc_count;type:integer;size:11;default:0;comment:分类下的内容统计数据;"`
	Type            int        `form:"type" json:"type,omitempty" gorm:"column:type;type:integer;size:1;default:0;index:idx_type;index:idx_unique_title,unique;comment:分类类型，0表示文档分类，1表示文章分类"`
	Sort            int        `form:"sort" json:"sort,omitempty" gorm:"column:sort;type:integer;size:11;default:0;index:idx_sort;comment:排序，值越大越靠前;"`
	Enable          bool       `form:"enable" json:"enable,omitempty" gorm:"column:enable;type:boolean;size:1;index:idx_enable;default:true;"`
	Description     string     `form:"description" json:"description,omitempty" gorm:"column:description;type:text;comment:分类描述;"`
	ShowDescription bool       `form:"show_description" json:"show_description,omitempty" gorm:"column:show_description;type:boolean;size:1;default:false;comment:是否显示描述;"`
